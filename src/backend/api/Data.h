...
public: // Functions to use in Python
    ...
    */
    ...
    bool                     SetUserDataPath(std::string path);         // modify 'm_UserDataPath' to where json data will be saved
    inline std::string       GetUserDataPath() { return this->m_UserDataPath; }
